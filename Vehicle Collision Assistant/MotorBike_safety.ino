...
 * Step 1 - Wait till you receive a message containing vehicle details during the step process
 * Step 2- Start the loop function, monitor the force sensor values 
 * Step 3- On accident Get GPS value and send multiple messages 
 * Step 4-On sending a message the app on that phone understands it and buzzer turns on the mobile. 
 * Step 5- Send the latitude and longitude value to the database via the app and display the location on Google Map.
 */
